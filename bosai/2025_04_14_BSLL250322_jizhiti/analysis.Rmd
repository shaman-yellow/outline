...
srn.luad <- step2(srn.luad, sct = TRUE)
...
mn.epithelial <- do_monocle(
  srn.luad, "epithelial_cells", group.by = "scsa_cell", resolution = 1.2, dims = 1:15,
  sct = TRUE
)
...
mn.epithelial@plots$step3$gene_module_heatdata$graph_test.sig
