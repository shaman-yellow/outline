...
`r snap(infe.epithelial, 0:1)`

```{r}
infe.epithelial <- asjob_infercnv(srn.luad, "endothelial_cells", "epithelial_cells")
...
infe.epithelial <- step1(infe.epithelial, 5)
infe.epithelial@object
