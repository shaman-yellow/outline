...
surv.tcga_luad@plots$step1$p.surv
surv.tcga_luad@plots$step1$p.roc
...
surv.luad_GSE31210@plots$step1$p.surv
surv.luad_GSE31210@plots$step1$p.roc
...
```{r}
katn.luad <- asjob_katn(srn.luad)
set_remoteRun.bosai(10)
katn.luad <- set_remote(katn.luad)
#' @meth {get_meth(katn.luad)}
katn.luad <- step1(katn.luad, 10, testLocal = TRUE)
katn.luad <- step2(katn.luad, 10)
