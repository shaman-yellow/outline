...
```{r include = F, eval = F}
info <- items(start = td("20241204"), end = td("20241220"), finish = td("2025-01-07"),
...
lm.ckd <- filter(lm.ckd, GENE_SYMBOL %in% feature(pat.common)[[1]])
...
vina.qingxin@params$dock_layout
...
vina.qingxin@plots$step5$p.res_vina
vina.qingxin@plots$step6$Top1_11252659_into_2z62
vina.qingxin@plots$step6$Top2_159655_into_2z62
vina.qingxin@plots$step7$Top1_11252659_into_2z62
...
autor(vina.qingxin@plots$step6$Top1_11252659_into_2z62)
```


```{r eval = T, echo = F, results = "asis"}
#| Docking-91424-into-2z62-detail
autor(vina.qingxin@plots$step7$)
```
