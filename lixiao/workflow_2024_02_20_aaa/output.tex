...
\NormalTok{sr}\OperatorTok{@}\NormalTok{params}\OperatorTok{$}\NormalTok{group.by}
\CommentTok{\# 以上也可以直接这么写：}
\NormalTok{sr}\OperatorTok{$}\NormalTok{group.by}
\end{Highlighting}
\end{Shaded}
...
\hypertarget{ux8c03ux6574ux56feux7247ux957fux5bbdux6bd4ux4f8bux7136ux540eux8f93ux51fa}{%
\paragraph{调整图片长宽比例，然后输出}\label{ux8c03ux6574ux56feux7247ux957fux5bbdux6bd4ux4f8bux7136ux540eux8f93ux51fa}}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{p\_my\_plot \textless{}{-}}\StringTok{ }\NormalTok{sr}\OperatorTok{@}\NormalTok{plots}\OperatorTok{$}\NormalTok{step1}\OperatorTok{$}\NormalTok{p.qc}
\NormalTok{p\_my\_plot \textless{}{-}}\StringTok{ }\KeywordTok{wrap}\NormalTok{(p\_my\_plot, }\DecValTok{20}\NormalTok{, }\DecValTok{20}\NormalTok{)}

\CommentTok{\# 或者按照相对比例}
\NormalTok{p\_my\_plot \textless{}{-}}\StringTok{ }\KeywordTok{zoom}\NormalTok{(p\_my\_plot, }\FloatTok{1.5}\NormalTok{, }\FloatTok{1.5}\NormalTok{)}

\CommentTok{\# 然后再输出图片}
\KeywordTok{autosv}\NormalTok{(p\_my\_plot, }\StringTok{"my{-}plot"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
