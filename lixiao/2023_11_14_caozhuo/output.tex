...
\def\@captype{figure}
\begin{center}
\includegraphics[width = 0.9\linewidth]{Figure+Table/cancer-trajectory-pseudotime.pdf}
...
\def\@captype{figure}
\begin{center}
\includegraphics[width = 0.9\linewidth]{Figure+Table/Cancer-trajectory-contrasts-DEGs-intersection.pdf}
...
\def\@captype{figure}
\begin{center}
\includegraphics[width = 0.9\linewidth]{Figure+Table/Cancer-vs-Epithelial-GSEA-plot-of-the-pathways.pdf}
...
\def\@captype{figure}
\begin{center}
\includegraphics[width = 0.9\linewidth]{Figure+Table/Cancer-trajectory-show-pathway-genes-in-pseudotime.pdf}
