...
silent only
silent tabonly
cd ~/outline/lixiao/2023_06_25_fix
...
argglobal
2argu
if bufexists("index.Rmd") | buffer index.Rmd | else | edit index.Rmd | endif
balt post_modify.R
let s:cpo_save=&cpo
set cpo&vim
...
silent! normal! zE
let &fdl = &fdl
let s:l = 136 - ((11 * winheight(0) + 12) / 24)
...
tabnext 1
badd +136 index.Rmd
badd +1179 ~/utils.tool/inst/extdata/library.bib
badd +101 ~/outline/lixiao/2023_06_30_eval/index.Rmd
badd +1 /tmp/tmpidqjsdcj/info.yaml
badd +1 b5
badd +69 ~/.vim/after/ftplugin/install.R
badd +231 ~/.vim/after/ftplugin/build.sh
badd +11 dep.Rmd
badd +7 post_modify.R
badd +1 install.R
