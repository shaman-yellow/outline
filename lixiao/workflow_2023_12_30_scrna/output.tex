...
\CommentTok{\# 你可以通过输入 \textquotesingle{}object(cc)@netP$pathways\textquotesingle{} 中的一个或多个 \textquotesingle{}pathway\textquotesingle{} 来运行}
\CommentTok{\# 例如:}
\CommentTok{\# cc \textless{}{-} step2(cc, head(object(cc)@netP$pathways, 6))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# 这会返回一个 \textquotesingle{}list\textquotesingle{}}
\NormalTok{lst.macro2test \textless{}{-}}\StringTok{ }\KeywordTok{map}\NormalTok{(cc, }\StringTok{"Macro"}\NormalTok{, }\StringTok{"Test\_1"}\NormalTok{)}
\NormalTok{lst.macro2test}\OperatorTok{$}\NormalTok{p}
\NormalTok{lst.macro2test}\OperatorTok{$}\NormalTok{data}
\end{Highlighting}
\end{Shaded}
