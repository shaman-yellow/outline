...
nnoremap  :%s/\n\{3,\}/\r\r/
nnoremap  :call Fix_string_pre()
vnoremap  :call Fix_string():call Fix_string_aft()
tnoremap 	 	
nnoremap 	[ ?functionf{i 
...
nnoremap <C-F> :call Fix_string_pre()
vnoremap <C-F> :call Fix_string():call Fix_string_aft()
...
silent only
silent tabonly
cd ~/outline/lixiao/2023_07_24_base
...
silent! normal! zE
let &fdl = &fdl
let s:l = 46 - ((13 * winheight(0) + 10) / 21)
...
tabnext 1
badd +1 index.Rmd
badd +1 post_modify.R
badd +5000 ~/utils.tool/inst/extdata/library.bib
badd +128 ~/.vim/after/ftplugin/rmd.vim
badd +85 ~/.vim/after/ftplugin/install.R
badd +97 ~/.vim/after/ftplugin/r.vim
badd +30 ~/.vim/after/ftplugin/removeOldClassReLoad.R
