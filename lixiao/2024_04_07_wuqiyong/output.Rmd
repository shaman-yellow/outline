...
```{r}
corp <- cal_corp(lm.mi, NULL, genesMGI.ppi$from, genesMGI.ppi$to, c("CoA_DEGs_ppi", "MI_key_DEGs_ppi"), use = "Genesymbol")
wrap(corp$hp, 20, 9)
corp$sig.corp
...
```{r}
lst.netEn <- plot_network.enrich(link.bothData, en, "go", less.label = F, edge_width = 1)
