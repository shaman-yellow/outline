...
output <- file.path(ORIGINAL_DIR, "12_immune")
...
iobr.GSE134347 <- asjob_iobr(lm.GSE134347)
iobr.GSE134347 <- step1(iobr.GSE134347, method = "cibersort")

iobr.GSE134347 <- step2(iobr.GSE134347)
iobr.GSE134347 <- step3(iobr.GSE134347, fea.markers)
clear(iobr.GSE134347)
...
output_with_counting_number({
  iobr.GSE134347@plots$step2$p.boxplot
  iobr.GSE134347@plots$step2$p.stack
  notshow(iobr.GSE134347@tables$step2$t.groupCor)
  iobr.GSE134347@plots$step2$p.cor
  notshow(iobr.GSE134347@tables$step2$t.cells_cor)
  z7(iobr.GSE134347@plots$step3$p.GeneCellCor, 1, 1.2)
  notshow(iobr.GSE134347@tables$step3$t.geneCellCor)
  notshow(iobr.GSE134347@params$allres$cibersort)
})
...
if (FALSE) {
    # iobr.GSE134347 <- asjob_iobr(lm.GSE134347)
    setMethod(f = "asjob_iobr", signature = c(x = "job_limma"), definition = function (x, 
        ...) 
    {
        .local <- function (x, use = .guess_symbol(x), project = x$project, 
