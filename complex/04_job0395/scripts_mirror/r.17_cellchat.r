...
output <- file.path(ORIGINAL_DIR, "17_cellchat")
...
srn.GSE167363 <- qs::qread("./rds_jobSave/srn.GSE167363.6.qs")

cc.GSE167363_healthy <- asjob_cellchat(
  getsub(srn.GSE167363, group == "healthy")
)
cc.GSE167363_healthy <- step1(cc.GSE167363_healthy)
cc.GSE167363_healthy <- step2(cc.GSE167363_healthy)
clear(cc.GSE167363_healthy)

cc.GSE167363_sepsis <- asjob_cellchat(
  getsub(srn.GSE167363, group == "sepsis")
)
cc.GSE167363_sepsis <- step1(cc.GSE167363_sepsis)
cc.GSE167363_sepsis <- step2(cc.GSE167363_sepsis)
clear(cc.GSE167363_sepsis)

cc.comparison <- asjob_cellchatn(
  list(healthy = cc.GSE167363_healthy, sepsis = cc.GSE167363_sepsis)
)
cc.comparison <- step1(cc.comparison)
cc.comparison <- step2(
  cc.comparison,
  as_feature("T_Cell", "关键细胞", nature = "cell")
)
clear(cc.comparison)
...
output_with_counting_number({
  ...
  cc.comparison@plots$step2$p.allCells_LP_comm_each_group$healthy
  cc.comparison@plots$step2$p.allCells_LP_comm_each_group$sepsis
  cc.comparison@plots$step2$p.keyCellAsSource
  cc.comparison@plots$step2$p.keyCellAsTarget
  notshow(cc.GSE167363_healthy@tables$step1$lp_net)
  notshow(cc.GSE167363_healthy@tables$step1$pathway_net)
  notshow(cc.GSE167363_healthy@tables$step2$t.lr_comm_bubble)
  notshow(cc.GSE167363_sepsis@tables$step1$lp_net)
  notshow(cc.GSE167363_sepsis@tables$step1$pathway_net)
  notshow(cc.GSE167363_sepsis@tables$step2$t.lr_comm_bubble)
...
if (FALSE) {
    # cc.GSE167363_healthy <- asjob_cellchat(getsub(srn.GSE167363, 
    #     group == "healthy"))
    ...
    # cc.GSE167363_sepsis <- asjob_cellchat(getsub(srn.GSE167363, group == 
    #     "sepsis"))
    setMethod(f = "asjob_cellchat", signature = c(x = "job_seurat"), 
        definition = function (x, ...) 
        {
    ...
    # cc.comparison <- asjob_cellchatn(list(healthy = cc.GSE167363_healthy, 
    #     sepsis = cc.GSE167363_sepsis))
    ...
    # cc.comparison <- step2(cc.comparison, as_feature("T_Cell", "关键细胞", 
    #     nature = "cell"))
