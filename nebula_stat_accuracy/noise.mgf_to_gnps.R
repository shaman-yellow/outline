...
file <- "/media/wizard/back/test_mcnebula/mgf/noise_gnps_pos.mgf"
## read
...
## write mgf
write.table(gnps_mgf, "/media/wizard/back/test_mcnebula/gnps_pos/mcnebula_results/gnps/gnps.noise_gnps_pos.mgf",
...
quant_meta <- dplyr::filter(quant_meta, `row ID` %in%
                          ...
                          `row m/z` <= 800)
file= "/media/wizard/back/test_mcnebula/gnps_pos/mcnebula_results/gnps/gnps.noise_quant.csv"
